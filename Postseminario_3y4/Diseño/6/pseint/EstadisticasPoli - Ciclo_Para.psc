Algoritmo EstadisticasPoli
	...
	Para cont<-1 Hasta 100 Hacer
		...
		Escribir ''
	FinPara
	Escribir 'Hay ',contM18F,' estudiantes menores de 18 años que fuman'
	...
	Escribir 'La menor edad del grupo de estudiantes de informatica es: ',edadMinI,' años'
	Escribir 'La mayor edad del grupo de estudiantes de informatica es: ',edadMI,' años'
FinAlgoritmo
